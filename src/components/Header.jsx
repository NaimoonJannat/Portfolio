const Header = () => {
    return (
        <nav className="navbar sticky top-0 z-50 bg-opacity-80 backdrop-blur-md flex justify-between items-center px-4 py-2 md:px-6 md:py-4 text-gray-800">
  <div className="navbar-start">
    <div className="dropdown">
      ...
      <ul
        ...
        <li><a className="text-gray-800 text-xl font-bold" href="#education">Education</a></li>
  ...
  <div className="navbar-center hidden lg:flex">
    <ul className="menu menu-horizontal px-1 space-x-2 md:space-x-4">
      ...
      <li><a href="#education" className="hover:text-gray-500 font-bold">Education</a></li>
